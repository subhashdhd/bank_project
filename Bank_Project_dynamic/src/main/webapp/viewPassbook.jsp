...
<body>
    ...
    List<Transaction> transactions =tdao.getTransaction(cust.getAcc_no());
        ...
        <div class="passbook-section">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    %>
                    <tr>
                        <td><%= transaction.getTran_id() %></td>
                        <td><%= transaction.getRec_acc() %></td>
                        <td><%= transaction.getTrans_date() %></td>
                        <td><%= transaction.getTrans_type() %></td>
