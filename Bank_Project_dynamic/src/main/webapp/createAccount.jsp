...
<body>
    ...
    <section class="form-section">
        <div class="form-card">
            ...
            <form action="createAccountServlet" method="post"> <!-- Change the action to your backend servlet or controller -->
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="confirmPassword" name="confirmPassword" placeholder="Confirm your pin" required>
                </div>
                <div class="d-grid">
